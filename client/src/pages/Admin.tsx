      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <Tabs defaultValue="site" className="space-y-6">
          <TabsList className="flex h-auto flex-wrap justify-start gap-2 rounded-2xl bg-slate-200/60 p-2">
            <TabsTrigger value="site">Site Editor</TabsTrigger>
            <TabsTrigger value="content">Blog & SEO</TabsTrigger>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Toggle edit mode to modify your homepage sections and existing website content</CardDescription>
                </CardHeader>
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Save homepage and section editor changes to the database</CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
              ...
              <CardContent>
                <ol className="list-decimal list-inside space-y-3 text-slate-600">
                  <li className="p-3 bg-slate-50 rounded-lg">
                    <strong>Enable Edit Mode</strong> - Turn editing on to make homepage content clickable
                  </li>
                  <li className="p-3 bg-slate-50 rounded-lg">
                    <strong>Go to Website</strong> - Open the site and use the floating tools to edit sections inline
                  </li>
                  <li className="p-3 bg-slate-50 rounded-lg">
                    <strong>Edit Sections</strong> - Reorder, hide, duplicate, or add homepage sections with the section manager
                  </li>
                  <li className="p-3 bg-slate-50 rounded-lg">
                    <strong>Save Changes</strong> - Return here or use the floating save button to persist all pending edits
                  </li>
                </ol>
              </CardContent>
            </Card>
